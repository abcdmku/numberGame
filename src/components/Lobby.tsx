  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4">
      <div className="w-full max-w-sm">
        ...
        <form onSubmit={handleSubmit} className="space-y-3">
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2.5 bg-zinc-900 border border-zinc-800 rounded-lg text-zinc-100 placeholder-zinc-600 focus:outline-none focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500/20 transition-colors duration-200"
          ...
          <button
            ...
            className={`w-full bg-emerald-600 text-white py-2.5 px-6 rounded-lg font-medium focus:outline-none focus:ring-1 focus:ring-emerald-500/50 transition-colors duration-200 flex items-center justify-center gap-2 ${
        ...
        <div className="mt-3 bg-zinc-900 border border-zinc-800 rounded-lg p-4" role="region" aria-labelledby="how-to-play-heading">
          <button
            type="button"
          ...
          >
            ...
            <h3 id="how-to-play-heading" className="text-sm font-medium text-zinc-100">How to Play</h3>
          </button>
          {showRules && (
            <div id="how-to-play-content" className="mt-3">
